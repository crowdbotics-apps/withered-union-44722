"""
Django settings for withered_union_44722 project.
...
ROOT_URLCONF = 'withered_union_44722.urls'
...
WSGI_APPLICATION = 'withered_union_44722.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_union_44722 API",
    "DESCRIPTION": "API documentation for withered_union_44722 App",
    "VERSION": "v1",
}
