...
## Project Structure
    ...
    ├── withered_union_44722  # Django project configurations
...
1. Clone this repo and `cd withered_union_44722`
...
2. Clone this repo and `cd withered_union_44722`
